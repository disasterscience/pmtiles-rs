...
impl PMTiles {
    ...
    pub async fn write(
        ...
        let finalised_tiles = self.tile_manager.build()?;
        ...
        let tile_count = finalised_tiles.tiles.len();
        for tile in finalised_tiles.tiles {
        ...
        trace!(
            ...
            tile_data_offset,
            finalised_tiles.total_tile_length,
            tile_count
        );
        ...
        let header = Header {
            ...
            leaf_directories_length,
            tile_data_offset,
            tile_data_length: finalised_tiles.total_tile_length,
            num_addressed_tiles: finalised_tiles.num_addressed_tiles,
            num_tile_entries: finalised_tiles.num_tile_entries,
            num_tile_content: finalised_tiles.num_tile_content,
            clustered: true,
